...
var webgl_utils = function(gl, width, height) {
  this.gl = gl;
  this.width = width;
  this.height = height;
...
webgl_utils.prototype.initCanvas = function() {
  var gl = this.gl;
...
webgl_utils.prototype.setPoints = function(data) {
  this.setData("position", data);
}

webgl_utils.prototype.setPointColors = function(data) {
  this.setData("colorIndex", data);
}

webgl_utils.prototype.setData = function(name, data, type) {
  var gl = this.gl;
...
webgl_utils.prototype.setBounds = function(xDomain, yDomain) {
  if (!arguments.length) {
    // pull from position
...
webgl_utils.prototype.getBounds = function() {
  return [this.xDomain, this.yDomain];
}

webgl_utils.prototype.getShader = function(name, vert, frag) {
  var gl = this.gl;
...
webgl_utils.prototype.createTexture = function(name, width, height, options) {
  var gl = this.gl;
...
webgl_utils.prototype.bindTexture = function(name, textureUnit) {
  var gl = this.gl;
  if (!isNaN(textureUnit) && textureUnit >= 8 && textureUnit < 0) {
    throw "textureUnit to webgl_utils.bindTexture should between 0 and 7, inclusive.";
  }
...
webgl_utils.prototype.unbindTexture = function(name, textureUnit) {
  var gl = this.gl;
  if (!isNaN(textureUnit) && textureUnit >= 8 && textureUnit < 0) {
    throw "textureUnit to webgl_utils.bindTexture should between 0 and 7, inclusive.";
  }
...
webgl_utils.prototype.drawPoints = function(options) {
  var gl = this.gl;
...
webgl_utils.prototype.drawQuad = function(options) {
  var gl = this.gl;
...
webgl_utils.prototype.getTextureData = function(name) {
  var gl = this.gl;
